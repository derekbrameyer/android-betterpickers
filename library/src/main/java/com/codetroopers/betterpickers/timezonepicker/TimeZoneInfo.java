...
public class TimeZoneInfo implements Comparable<TimeZoneInfo> {
  ...
  private static SparseArray<CharSequence> mGmtDisplayNameCache = new SparseArray<CharSequence>();
  ...
  public String getLocalTime(long referenceTime) {
    ...
    int hourMinute = recycledTime.hour * 60 + recycledTime.minute;
  ...
  public int compareTo(@NonNull TimeZoneInfo other) {
    ...
    if (Arrays.equals(this.mTransitions, other.mTransitions)) {
      Log.e(
          TAG,
          "Not expected to be comparing tz with the same country, same offset,"
    ...
    return this.mTz
        ...
        .compareTo(other.mTz.getDisplayName(Locale.getDefault()));
  }
}
